...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateQuests()
        {
            ...
            clearAlchemistGarden.QuestCompletionItems.Add(new QuestCompletionItems(ItemByID(ITEM_ID_RAT_TAIL), 3));
            ...
            clearFarmersField.QuestCompletionItems.Add(new QuestCompletionItems(ItemByID(ITEM_ID_SNAKE_FANG), 3));
